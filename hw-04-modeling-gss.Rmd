...
**Answer:**
The metrics provided above show that the **ROC** curve for Model 1 is 0.534 while the **ROC** curve for Model 2 is 0.529. Based on this, Model 1 is the preferable model for training data.
